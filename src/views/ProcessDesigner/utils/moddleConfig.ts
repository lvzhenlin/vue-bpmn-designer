export const activitiConfig = {
  ...
  "types": [
    ...
    },
    {
      ...
      "superClass": ["Element"],
      "meta": {
        "allowedIn": ["activiti:ServiceTaskLike", "bpmn:ServiceTask"]
      },
      "properties": [
        { "name": "errorCode", "isAttr": true, "type": "String" },
        { "name": "includeChildExceptions", "isAttr": true, "default": false, "type": "Boolean" },
        { "name": "exceptionClass", "isBody": true, "type": "String" }
      ]
    },
    {
      "name": "InOutBinding",
    ...
    },
    {
      ...
      "extends": ["bpmn:Error"],
      "properties": [
        { "name": "activiti:errorMessage", "isAttr": true, "type": "String" }
      ]
    },
    {
    ...
    },
    {
      ...
      "properties": [
        ...
        { "name": "formReadOnly", "isAttr": true, "type": "Boolean", "default": false },
        { "name": "formInit", "isAttr": true, "type": "Boolean", "default": true }
      ]
    },
    {
    ...
    },
    {
      ...
      "properties": [
        ...
        { "name": "autoStoreVariables", "isAttr": true, "type": "Boolean", "default": false },
    ...
    },
    {
      ...
      "properties": [
        ...
        { "name": "followUpDate", "isAttr": true, "type": "String" },
    ...
    },
    {
      ...
      "properties": [
        ...
        { "name": "viewId", "type": "Number", "isAttr": true }
      ]
    },
    {
      "name": "CallActivity",
    ...
    },
    {
      ...
      "properties": [
        { "name": "id", "type": "String", "isAttr": true },
        { "name": "name", "type": "String", "isAttr": true },
        { "name": "code", "type": "String", "isAttr": true },
        { "name": "isHide", "type": "String", "isAttr": true },
        { "name": "next", "type": "String", "isAttr": true },
        { "name": "sort", "type": "Integer", "isAttr": true }
      ]
    },
    {
      "name": "Assignee",
      ...
      "properties": [
        ...
        { "name": "value", "type": "String", "isAttr": true },
        { "name": "condition", "type": "String", "isAttr": true },
        { "name": "operationType", "type": "String", "isAttr": true },
        { "name": "sort", "type": "Integer", "isAttr": true }
      ]
    },
    {
    ...
    },
    {
      ...
      "superClass": ["Element"],
      "meta": {
        "allowedIn": ["activiti:ServiceTaskLike", "activiti:ExecutionListener", "activiti:TaskListener", "bpmn:ServiceTask"]
      },
      "properties": [
        { "name": "name", "isAttr": true, "type": "String" },
        ...
        { "name": "htmlVar", "type": "Expression" }
      ]
    },
    {
      "name": "VariableListenerEventDefinition",
      "superClass": ["bpmn:EventDefinition"],
      "meta": {
        "allowedIn": ["bpmn:StartEvent", "bpmn:IntermediateCatchEvent", "bpmn:IntermediateThrowEvent", "bpmn:BoundaryEvent"]
      },
      "properties": [
        { "name": "variableName", "isAttr": true, "type": "String" },
        { "name": "variableChangeType", "isAttr": true, "type": "String" }
      ]
    },
    {
      "name": "ChildField",
    ...
    },
    {
      ...
      "properties": [
        ...
        { "name": "noWaitStatesAsyncLeave", "isAttr": true, "type": "Boolean", "default": false }
      ]
    },
    {
      "name": "Collection",
      "superClass": ["Element"],
      "meta": {
        "allowedIn": ["bpmn:MultiInstanceLoopCharacteristics"]
      },
      "properties": [
        { "name": "delegateExpression", "isAttr": true, "type": "String" },
        { "name": "class", "isAttr": true, "type": "String" },
    ...
    },
    {
      ...
      "properties": [
        { "name": "values", "type": "Variable", "isMany": true },
        { "name": "target", "isAttr": true, "type": "String" },
    ...
    },
    {
      ...
      "superClass": ["Element"],
      "meta": {
        "allowedIn": ["activiti:VariableAggregation"]
      },
      "properties": [
        { "name": "source", "isAttr": true, "type": "String" },
        { "name": "sourceExpression", "isAttr": true, "type": "String" },
    ...
    },
    {
      ...
      "superClass": ["Element"],
      "meta": {
        "allowedIn": ["bpmn:Task", "bpmn:ServiceTask", "bpmn:UserTask", "bpmn:BusinessRuleTask", "bpmn:ScriptTask", "bpmn:ReceiveTask", "bpmn:ManualTask", "bpmn:ExclusiveGateway", "bpmn:SequenceFlow", "bpmn:ParallelGateway", "bpmn:InclusiveGateway", "bpmn:EventBasedGateway", "bpmn:StartEvent", "bpmn:IntermediateCatchEvent", "bpmn:IntermediateThrowEvent", "bpmn:EndEvent", "bpmn:BoundaryEvent", "bpmn:CallActivity", "bpmn:SubProcess", "bpmn:Process"]
      },
      "properties": [
        { "name": "expression", "isAttr": true, "type": "String" },
        { "name": "class", "isAttr": true, "type": "String" },
    ...
    },
    {
      ...
      "properties": [
        ...
        { "name": "default", "type": "String", "isAttr": true },
        { "name": "values", "type": "Value", "isMany": true },
        { "name": "children", "type": "ChildField", "isMany": true },
        { "name": "extensionElements", "type": "bpmn:ExtensionElements", "isMany": true }
      ]
    },
    {
      "name": "FormData",
    ...
    },
    {
      ...
      "properties": [
        { "name": "id", "type": "String", "isAttr": true },
        { "name": "field", "type": "String", "isAttr": true },
        { "name": "compare", "type": "String", "isAttr": true },
        { "name": "value", "type": "String", "isAttr": true },
        { "name": "logic", "type": "String", "isAttr": true },
        { "name": "sort", "type": "Integer", "isAttr": true }
      ]
    }
  ],
...
export const flowableConfig = {
  ...
  "types": [
    ...
    },
    {
      ...
      "superClass": ["Element"],
      "meta": {
        "allowedIn": ["flowable:ServiceTaskLike", "bpmn:ServiceTask"]
      },
      "properties": [
        { "name": "errorCode", "isAttr": true, "type": "String" },
        { "name": "includeChildExceptions", "isAttr": true, "default": false, "type": "Boolean" },
    ...
    },
    {
      ...
      "extends": ["bpmn:Error"],
      "properties": [
        { "name": "flowable:errorMessage", "isAttr": true, "type": "String" }
      ]
    },
    {
      "name": "PotentialStarter",
    ...
    },
    {
      ...
      "superClass": ["Element"],
      "meta": {
        "allowedIn": ["flowable:VariableAggregation"]
      },
      "properties": [
        { "name": "source", "isAttr": true, "type": "String" },
        { "name": "sourceExpression", "isAttr": true, "type": "String" },
