...
import activityLabelRequired from './rules/activity-label-required'
import userTaskRequired from './rules/user-task-required'
// import gatewayJoin from './rules/gateway-join'
import serviceTaskRequired from './rules/service-task-required'
import messageEventRequired from './rules/message-event-required'
import compensateEventRequired from './rules/compensate-event-required'
import errorEventRequired from './rules/error-event-required'
import escalationEventRequired from './rules/escalation-event-required'
import signalEventRequired from './rules/signal-event-required'
import timerEventRequired from './rules/timer-event-required'
import conditionalEventRequired from './rules/conditional-event-required'
import scriptTaskRequired from './rules/script-task-required'
import multiInstanceRequired from './rules/multi-instance-required'
import httpTaskRequired from './rules/http-task-required'
import callActivityRequired from './rules/call-activity-required'
import variableEventRequired from './rules/variable-event-required'
import sequenceFlowsRequired from './rules/sequence-flows-required'
import eventSubProcessTypedStartEvent from './rules/event-sub-process-typed-start-event'
